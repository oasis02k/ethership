...
export default function Nav({ onMenuClick }: { onMenuClick: () => void }) {
  return (
    <nav className="fixed top-4 left-5 md:left-6 right-[calc(1.25rem+var(--scrollbar-comp,0px))] md:right-[calc(1.5rem+var(--scrollbar-comp,0px))] h-14 bg-[#2e2e2b] rounded-[4px] flex items-center px-5 md:px-6 z-20">
